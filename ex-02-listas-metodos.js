...
*/
// Operações necessárias e resposta a partir da linha abaixo
let ultimo1 = listaAnimais.pop()
listaAnimais.unshift(ultimo1)

let ultimo2 = listaAnimais.pop()
listaAnimais.unshift(ultimo2)

let ultimo3 = listaAnimais.pop()
listaAnimais.unshift(ultimo3)
...
let a = listaAnimais.shift()
listaAnimais.push(a)

let b = listaAnimais.shift()
listaAnimais.push(b)

let c = listaAnimais.shift()
listaAnimais.push(c)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
let lista10 = listaAnimais.concat(["carcará", "morcego", "salmão"])
lista10.reverse()
lista10 = lista10.concat(["lesma", "borboleta", "ostra"])
...
// Operações necessárias e resposta a partir da linha abaixo
const removidas = []
removidas.push(listaPedras.pop())
removidas.push(listaPedras.pop())
removidas.push(listaPedras.pop())
removidas.push(listaPedras.pop())
removidas.push(listaPedras.pop())
...
export const resposta14 = removidas
